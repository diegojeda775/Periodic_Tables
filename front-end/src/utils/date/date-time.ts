 ...
 */
export function formatAsDate(dateString: any) {
 ...
 */
export function formatAsTime(timeString: any) {
 ...
 */
export function previous(currentDate: any) {
 ...
 */
export function next(currentDate: any) {
  let [year, month, day] = currentDate.split("-");
  month -= 1;
  const date = new Date(year, month, day);
  date.setMonth(date.getMonth());
